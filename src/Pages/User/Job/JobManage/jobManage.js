...
export default function JobManage() {
    ...
    const handleChangeWait = (event) => {
        setReasonWait(event.target.value);
    };
    ...
    return (
        <>
            ...
            <div className='container'>
                ...
                <div className={toggleTab === 1 ? "job-favorite" : "job-favorite none-active-post-content"}>
                    ...
                    <div className='job-manage-list'>
                        {listJobCare && listJobCare.length > 0 &&
                            listJobCare.map((item, index) => {
                                return (
                                    <div className="all-job-list-detail" style={{minHeight: '160px'}}>
                ...
                <div className={toggleTab === 2 ? "job-history" : "job-history none-active-post-content"}>
                    <div className='job-manage-quantity'>
                        <div className='job-manage-quantity-item'>
                    ...
                    <div className='job-manage-list'>
                        {listJobHistory && listJobHistory.length > 0 &&
                            listJobHistory.map((item, index) => {
                                return (
                                    <div className="all-job-list-detail" style={{height: '160px'}}>
                                        <div className='job-list-item'>
                                            <div className='job-list-item-left'>
                                                <div className="job-list-logo">
                                                    <img id='company-logo' src={logo_job} alt="" />
                                            ...
                                            {item.isComment === 1 ? (
                                                ...
                                                <div className='job-list-item-right'>
                                                    <Button onClick={() => handleClickOpenHistory(item.jobAppId)} style={{
                                                        fontSize: '14px',     // Điều chỉnh kích thước chữ
                                                        padding: '10px 20px',   // Điều chỉnh kích thước nút
                                                        marginTop: '50px',
                                                        marginLeft: '80px'     // Điều chỉnh khoảng cách từ top
                                ...
                                return (
                                    <div className="all-job-list-detail" style={{height: '160px'}}>
                                        <div className='job-list-item'>
                                            ...
                                            <div className='job-list-item-right'>
                                                <Button onClick={() => CanceApplyWait(item.jobAppId)} style={{
                                                    fontSize: '14px',     // Điều chỉnh kích thước chữ
                                                    padding: '10px 20px',   // Điều chỉnh kích thước nút
                                                    marginTop: '50px',
                ...
                <div className={toggleTab === 4 ? "job-cancel" : "job-cancel none-active-post-content"}>
                    ...
                    <div className='job-manage-list'>
                        {listJobCancel && listJobCancel.length > 0 &&
                            listJobCancel.map((item, index) => {
                                return (
                                    <div className="all-job-list-detail" style={{height: '160px'}}>
                                        <div className='job-list-item'>
                                            <div className='job-list-item-left'>
